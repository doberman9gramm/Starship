...
public class csShurikenEffectEditor : EditorWindow
{
	...
	[MenuItem("Window/Shuriken System _effects Editor")]
    [System.Obsolete]
    ...
    void OnGUI()
    {
        GUILayout.Box("Shuriken System _effects Scale Editor", GUILayout.Width(295));
        EditorGUILayout.Space();
        Effect = (GameObject)EditorGUILayout.ObjectField("Shuriken System _effects", Effect, typeof(GameObject), true);
        EditorGUILayout.Space();
        EditorGUILayout.Space();
        EditorGUILayout.Space();
        EditorGUILayout.Space();
